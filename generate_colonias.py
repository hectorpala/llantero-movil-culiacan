#!/usr/bin/env python3
"""
Generador de páginas de colonias para Llantera Móvil Culiacán Pro.
Lee los slugs de colonias del proyecto plomero y genera páginas HTML
equivalentes para el proyecto llantero.

Uso: python3 generate_colonias.py
"""
import os
import urllib.parse

# Directorios
PLOMERO_COLONIAS = "/Users/hectorpc/Documents/Hector Palazuelos/Google My Business/plomero culiacan pro/servicios/plomero-colonias-culiacan"
LLANTERO_COLONIAS = "/Users/hectorpc/Documents/Hector Palazuelos/Google My Business/llantero movil culiacan pro/servicios/llantero-colonias-culiacan"

# Preposiciones que no se capitalizan
PREPOSICIONES = {'de', 'del', 'la', 'las', 'los', 'el', 'en', 'y', 'e', 'a'}

def slug_to_name(slug):
    """Convierte un slug a nombre legible: 'zona-dorada' -> 'Zona Dorada'"""
    words = slug.replace('-', ' ').split()
    result = []
    for i, w in enumerate(words):
        if i == 0 or w.lower() not in PREPOSICIONES:
            result.append(w.capitalize())
        else:
            result.append(w.lower())
    return ' '.join(result)

def generate_page(slug, name):
    """Genera el HTML completo para una página de colonia."""
    name_encoded = urllib.parse.quote(name)
    wa_text = urllib.parse.quote(f"Hola, necesito llantera móvil en {name}")
...
<meta name="author" content="Llantero Movil Culiacan Pro">
...
<nav class="nav"><div class="container"><div class="nav-wrapper">
  <a href="/" class="logo"><img src="/assets/images/logo-llantero-512.webp" alt="Llantero Movil Culiacan Pro" width="512" height="195"></a>
...
<div class="breadcrumb"><div class="container">
  <a href="/">Inicio</a> &raquo; <a href="/servicios/llantero-colonias-culiacan/">Colonias</a> &raquo; <span>{name}</span>
</div></div>
...
<div class="container">
  ...
  <section class="content-section section-alt" id="servicios">
    <h2>Servicios de Llantera en {name}</h2>
    <div class="grid">
      <div class="card"><h3>Cambio de Llantas</h3><p>Cambio de llantas a domicilio en {name}. Todas las medidas y marcas disponibles.</p></div>
      <div class="card"><h3>Reparaci&oacute;n de Ponchaduras</h3><p>Reparamos ponchaduras en el lugar. Servicio r&aacute;pido sin necesidad de gr&uacute;a.</p></div>
      <div class="card"><h3>Vulcanizado</h3><p>Vulcanizado profesional para llantas con da&ntilde;o lateral o en la banda de rodamiento.</p></div>
      <div class="card"><h3>Alineaci&oacute;n y Balanceo</h3><p>Alineaci&oacute;n y balanceo para un manejo seguro y parejo.</p></div>
      <div class="card"><h3>Venta de Llantas</h3><p>Llantas nuevas y seminuevas de las mejores marcas. Instalaci&oacute;n incluida.</p></div>
      <div class="card"><h3>Emergencias 24/7</h3><p>Llanta ponchada de noche o madrugada en {name}? Llegamos en minutos.</p></div>
    </div>
  </section>
  ...
  <section class="cta-section">
    <h2>&iquest;Necesitas llantera m&oacute;vil en {name}?</h2>
    <p>Estamos disponibles 24/7. Cont&aacute;ctanos por WhatsApp para cotizaci&oacute;n inmediata o ll&aacute;manos directo.</p>
    <div class="cta-buttons">
      <a href="https://wa.me/526673922273?text={wa_text}" class="btn-primary btn-whatsapp" target="_blank" rel="noopener noreferrer">WhatsApp: 667-392-2273</a>
      <a href="tel:+526673922273" class="btn-secondary">Llamar: 667-392-2273</a>
    </div>
  </section>
</div>
</article>
...
<footer class="footer"><div class="container">
  <div class="footer-logo"><img src="/assets/images/logo-llantero-512.webp" alt="Llantero Movil Culiacan Pro" width="512" height="195"></div>
  <div class="footer-links"><ul>
    <li><a href="/">Inicio</a></li>
    <li><a href="/servicios/cambio-de-llanta/">Cambio de Llanta</a></li>
    <li><a href="/servicios/reparacion-de-ponchadura/">Reparacion de Ponchadura</a></li>
    <li><a href="/servicios/vulcanizadora-movil/">Vulcanizadora Movil</a></li>
    <li><a href="/servicios/llantero-24-horas/">Llantero 24 Horas</a></li>
    <li><a href="/servicios/llantero-a-domicilio/">Llantero a Domicilio</a></li>
    <li><a href="/servicios/llantero-cerca-de-mi/">Llantero Cerca de Mi</a></li>
    <li><a href="/servicios/llantero-de-emergencia/">Llantero de Emergencia</a></li>
    <li><a href="/servicios/alineacion-y-balanceo/">Alineacion y Balanceo</a></li>
    <li><a href="/servicios/venta-de-llantas/">Venta de Llantas</a></li>
    <li><a href="/servicios/llantero-precios/">Precios</a></li>
  </ul></div>
  <p>&copy; 2025 Llantero M&oacute;vil Culiac&aacute;n Pro. Todos los derechos reservados.</p>
</div></footer>

<a href="https://wa.me/526673922273?text={wa_text}" class="floating-btn floating-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp"><svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg></a>
...
def main():
    # Get colony slugs from plomero project
    entries = sorted(os.listdir(PLOMERO_COLONIAS))
    colonies = [e for e in entries if os.path.isdir(os.path.join(PLOMERO_COLONIAS, e))]
    print(f"Found {len(colonies)} colonies")

    os.makedirs(LLANTERO_COLONIAS, exist_ok=True)

    count = 0
    for slug in colonies:
        name = slug_to_name(slug)
        html = generate_page(slug, name)
        out_dir = os.path.join(LLANTERO_COLONIAS, slug)
    ...
    print(f"DONE: Generated {count} colony pages")
