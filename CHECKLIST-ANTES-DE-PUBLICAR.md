...
□ ¿Tiene imagen de fondo? (NO debe verse overlay oscuro sobre llanta)
...
□ **VERIFICAR:** Imagen es `llantero-movil-hero-800w.webp` y `llantero-movil-hero-1200w.webp`
...
□ **Teléfono:** ¿Es azul #E36414 con ícono SVG? (NO emoji 📞)
...
□ Los únicos colores deben ser del brand (naranja #E36414, #F97316)
...
|-------|--------------|----------|
| Hero incorrecto | Tubería con overlay oscuro | Debe usar `<picture>` y llantero-movil-hero |
...
| Imagen equivocada | Se ve diferente al homepage | Cambiar por llantero-movil-hero-*.webp |

---

**Última actualización:** Febrero 2026
**Basado en:** 5 commits de correcciones del artículo "articulos de llantero"
